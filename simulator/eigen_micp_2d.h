...
struct MICP2D {
  ...
  void plotMetrics(std::string paramConvergence, std::string paramConvergence_motions);     
protected:
  ...
  Vector3f _K;
  Eigen::Matrix3f _H=Eigen::Matrix3f::Zero();
  Eigen::Matrix3f _H_init=Eigen::Matrix3f::Zero();
  Eigen::Vector3f _b=Eigen::Vector3f::Zero();
  Eigen::Vector3f _b_init=Eigen::Vector3f::Zero();
